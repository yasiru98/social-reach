    ...
    render() {
        return(
            <>
                <div>
                    <RevSlider
                        revId={"rev_slider_7_1"}
                    >
                      <rs-slide data-key="rs-4" data-title="Slide" data-anim="ei:d;eo:d;s:1000;r:0;t:fade;sl:0;">
							<img src="./static/assets/revslider/assets_slider_demo7/transparent.png" className="rev-slidebg" data-no-retina />
							<rs-bgvideo 
								data-video="w:100%;h:100%;nse:false;l:true;ptimer:true;"
								data-mp4="./static/assets/revslider/assets_slider_demo7/demo7.mp4"
							></rs-bgvideo>
                     <rs-layer
							...
							><img src="./static/assets/revslider/assets_slider_demo7/demo7-rev-bg.png" width="1198" height="955" data-no-retina /> 
							</rs-layer>
                     <rs-layer
                     ...
                     <rs-layer
							...
							><img src="./static/assets/revslider/assets_slider_demo7/demo7-rev-06.png" width="133" height="132" data-no-retina /> 
							</rs-layer>
                     <rs-layer
							...
							><img src="./static/assets/revslider/assets_slider_demo7/demo7-rev-05.png" width="453" height="119" data-no-retina /> 
							</rs-layer>
                     <rs-layer
							...
							><img src="./static/assets/revslider/assets_slider_demo7/demo7-rev-07.png" width="127" height="126" data-no-retina /> 
							</rs-layer>
                     <rs-layer
								...
								style={{zIndex:18,fontFamily:"Lato",textTransform:"uppercase"}}
							>40%<br />Mad 
							</rs-layer>
                     <rs-layer
								...
								style={{zIndex:19,fontFamily:"Lato",textTransform:"uppercase"}}
							>80%<br />Happy 
							</rs-layer>
                     <rs-layer
                     ...
                     <rs-layer
								...
								style={{zIndex:23,backgroundColor:"#ffffff",fontFamily:"Lato"}}
                     ...
                     <rs-layer
							...
							><img src="./static/assets/revslider/assets_slider_demo7/01.png" width="285" height="285" data-no-retina /> 
							</rs-layer>
                     <rs-layer
								...
								style={{zIndex:24,backgroundColor:"rgba(76,217,235,0.5)",fontFamily:"Roboto"}}
							> 
							</rs-layer>
					</rs-slide>
                    </RevSlider>
