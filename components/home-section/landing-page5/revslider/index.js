            ...
            <>
                <div>
                    ...
                    >
							...
							<img src="./static/assets/revslider/assets_slider6/dummy.png" title="demo5-rev-bg" width="1600" height="896" data-lazyload="./static/assets/revslider/assets_slider6/demo5-rev-bg.png" data-parallax="off" className="rev-slidebg" data-no-retina />
							...
							<rs-layer
								...
								style={{zIndex:16,backgroundColor:"#ebecf6",fontFamily:"Roboto"}}
							><a className="text-center"><i className="fab fa-twitter"></i></a> </rs-layer>
							<rs-layer
								...
								data-frame_999="o:0;st:w;"
								data-frame_hover="c:#fff;bgc:#437eeb;bor:90px,90px,90px,90px;"
								style={{zIndex:17,backgroundColor:"#ebecf6",fontFamily:"Lato"}}
							><a className="text-center "><i className="fab fa-instagram"></i></a></rs-layer>
							<rs-layer
								...
								data-border="bor:90px,90px,90px,90px;"
								data-frame_999="o:0;st:w;"
								style={{zIndex:18,backgroundColor:"#eaebf5",fontFamily:"Lato"}}
							><a className="text-center"><i className="fab fa-facebook"></i></a></rs-layer>
							<rs-layer
							...
							><img src="./static/assets/revslider/assets_slider6/dummy.png" width="1418" height="1406" data-lazyload="./static/assets/revslider/assets_slider6/demo5-rev-01.png" data-no-retina /> 
							</rs-layer>
							<rs-layer
								...
								style={{zIndex:9,fontFamily:"Lato",textTransform:"capitalize"}}
							>Changing the way you think <br />About Data 	</rs-layer>
							<rs-layer
							...
							><img src="./static/assets/revslider/assets_slider6/dummy.png" data-lazyload="./static/assets/revslider/assets_slider6/demo5-rev-02.png" data-no-retina /> 
							</rs-layer><rs-layer
						...
						><img src="./static/assets/revslider/assets_slider6/dummy.png" data-lazyload="./static/assets/revslider/assets_slider6/demo5-rev-03.png" data-no-retina /> 
							</rs-layer><rs-layer
						...
						><img src="./static/assets/revslider/assets_slider6/dummy.png" width="521" height="433" data-lazyload="./static/assets/revslider/assets_slider6/demo5-rev-04-1.png" data-no-retina /> 
							</rs-layer><rs-layer
						...
						><img src="./static/assets/revslider/assets_slider6/dummy.png" data-lazyload="./static/assets/revslider/assets_slider6/demo5-rev-05.png" data-no-retina /> 
							</rs-layer>
						</rs-slide>
                    </RevSlider>
                </div>
