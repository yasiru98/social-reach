...
import { SectionTitle, Portfolio2 } from '../../../xamin';
            ...
            <>
                <section className="pt-0">
                    <div className="container">
                        <div className="row">
                            <div className="col-sm-12 fadeInUp  animated">
                                <SectionTitle
                             ...
                             <div className="col-md-12">
                                <div id="features" className="iq-amazing-tab wow fadeInUp" data-wow-delay="1s">
                                        ...
                                        <div className="tab-content portfolioslider2 ">
                                            { tabs.map((tab,index) => (
                                                    ...
                                                    <div className="row flex-row-reverse">
                                                        <div className="col-lg-12 text-left align-self-center">
                                                            <div className="owl-carousel owl-loaded owl-drag"
                                                                ...
                                                                <Portfolio2 filterdata={tab.href} /> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
